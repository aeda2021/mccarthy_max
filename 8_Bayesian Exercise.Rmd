...
*Answer:*
The expected number of burrows is 10.70 (95% CI: 9.68-12.68). In this model, the intercept predicts the number of burrows at the mean salinity value. If salinity was not centered, the intercept would instead predict the number of burrows at zero salinity. For every 1-unit increase in log salinity, the number of burrows is predicted to increase by about 1.03 (95% CI: 1.02-1.05). Considering these results, it appears there is a <5% probability that salinity actually has no effect.
