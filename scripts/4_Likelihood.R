...
fm4 <- glm(Survived ~ Sex, family = "binomial", data = titanic)
fm5 <- glm(Survived ~ Pclass, family = "binomial", data = titanic)
fm6 <- glm(Survived ~ Sex + Pclass, family = "binomial", data = titanic)
fm7 <- glm(Survived ~ Sex + Age, family = "binomial", data = titanic)
...
model.sel(fm0, fm3, fm4, fm5, fm6, fm7)
...
pois.test <- fitdist(dat.test, "pois")
summary(pois.test)
nbinom.test <- fitdist(dat.test, "nbinom")
summary(nbinom.test)
?fitdist
